...
def test_sigmoid(a: float) -> None:
    ...
    * It is  strictly increasing.
    ...
    if a == 0:
        assert sigmoid(a) == 0.5, "Sigmoid of 0 should be 0.5"
    
    # Testing strictly increasing property
    if a != 0:
        delta = 0.1
        assert sigmoid(a - delta) <= sigmoid(a) <= sigmoid(a + delta), "Sigmoid should be strictly increasing"
